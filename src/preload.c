...
#define SU_DST_DIR "/apex/com.android.virt/app"
 ...
 * next to the su client so exp_stack_once() can execve() it. Runs
 * pre-root in /data/local/tmp, so no chcon/chown games are needed.
 */
